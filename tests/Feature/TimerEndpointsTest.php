...
describe('Timer endpoints', function () {
    it('can create a timer', function () {
        ...
        $data = new Data\Timers\TimerRequestData(
            ...
            appearance: Enums\Appearance::Countdown,
            type: Enums\Type::FinishTime,
            hours: 1,
            minutes: 30,
            seconds: 15,
            wrapUpYellow: 60 * 15,
            wrapUpRed: 60 * 5,
            trigger: Enums\Trigger::Scheduled,
        ...
        expect($stagetimer->timers()->create(roomId: 'theroom', data: $data))
            ...
            ->timer->appearance->toBe(Enums\Appearance::Countdown)
            ->timer->type->toBe(Enums\Type::FinishTime)
    ...
    it('can update a timer', function () {
        ...
        $data = new Data\Timers\TimerRequestData(
            ...
            appearance: Enums\Appearance::CountdownTod,
            type: Enums\Type::Duration,
            hours: 0,
            minutes: 45,
            seconds: 30,
            wrapUpYellow: 60 * 10,
            wrapUpRed: 60 * 5,
            trigger: Enums\Trigger::Manual,
        ...
        expect($stagetimer->timers()->update(roomId: 'theroomid', timerId: 'thetimerid', data: $data))
            ...
            ->timer->appearance->toBe(Enums\Appearance::CountdownTod)
            ->timer->type->toBe(Enums\Type::Duration)
